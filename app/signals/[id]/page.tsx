  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <article>
        ...
        {(signal.source || signal.url) && (
          <div className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 border border-gray-100 mb-6">
            <div className="flex-1">
              {signal.source && (
                <p className="text-xs font-semibold text-gray-500">Fuente: {signal.source}</p>
              )}
            </div>
            {signal.url && (
              <a
        ...
        {/* Author + Vote */}
        <div className="flex items-center justify-between mb-8 pt-4 border-t border-gray-100">
